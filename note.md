...
\[
e_2 = -\frac{p_1}{p_2} e_1 - \frac{p_0}{p_2}
\]
...
Objectif :
trouver les poids qui minimisent le nombre d’erreurs.
...
\[
p_{ij} \leftarrow p_{ij} - \eta \delta_j e_i
\]
...
Objectif :
généraliser à des données jamais vues.
